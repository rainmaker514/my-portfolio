...
mobileMenuIcon.addEventListener("click", () => {
  if(icon.classList.contains('fa-xmark')){
    icon.style.textShadow='unset';
  } else{
    icon.style.textShadow='0 0 7px #5900b3, 0 0 10px #5900b3, 0 0 21px #5900b3, 0 0 42px #5900b3, 0 0 82px #5900b3, 0 0 92px #5900b3, 0 0 102px #5900b3, 0 0 151px #5900b3';
  }
